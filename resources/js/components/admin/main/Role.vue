...
12],
    ...
    computed: {
        isSelectedAll() {
            return this.selectedItems.length >= this.roles.length;
        },
        isAnyItemSelected() {
            return (
                ...
                .then(res => {
                    if (res = true) {
                        ...
                        axios
                            ...
                            .then(resp => {
                                const index = app.roles.findIndex(
                                    role => role.id === id
                                );
                                if (~index) app.roles.splice(index, 1);
                            })
                            .catch(resp => {

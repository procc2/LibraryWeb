                ...
                <div class="col-md-12">
                    <form role="form" v-on:submit="saveForm()">
                        <div class="form-group">
                            ...
                            <input v-model="publisher.publisher_name" class="form-control" type="text" required="">
                        </div>																					
...
<script>
    export default {
        mounted() {
            ...
            app.publisher_id = id;
            axios.get('/api/v1/publishers/' + id)
                .then(function (resp) {
        ...
        methods: {
            saveForm() {
                ...
                if(typeof app.$route.params.id !== 'undefined'){
                    axios.put("/api/v1/publishers/"+app.$route.params.id,publisher)
                    .then(function (resp) {
                        console.log(resp);
                ...
                axios.post("/api/v1/publishers",publisher)
                    .then(function (resp) {
                        console.log(resp);
                        app.$router.push({path: '/publisher'});
                    })

        ...
        <b-colxx xxs="12">
          ...
          <div class="top-right-button-container">
            <b-button
              ...
              @click="$router.push('publisher/insert')"
            >
              {{ $t("pages.add-new") }}
            </b-button>
            <b-button-group>
          ...
          >
            ...
            <template v-slot:cell(delete)="row">
              <a
                ...
                @click="deleteEntry(row.item.publisher_id)"
              >
                <span>
                  <svg
...
12],
    ...
    computed: {
        isSelectedAll() {
            return this.selectedItems.length >= this.publishers.length;
        },
        isAnyItemSelected() {
            return (
                ...
                .then(res => {
                    if (res = true) {
                        ...
                        axios
                            ...
                            .then(resp => {
                                const index = app.publishers.findIndex(
                                    publisher => publisher.publisher_id === id
                                );
                                if (~index) app.publishers.splice(index, 1);
                            })
                            .catch(resp => {

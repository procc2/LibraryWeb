                ...
                <div class="col-md-12">
                    <form role="form" v-on:submit="saveForm()">
                        <div class="form-group">
                            ...
                            <input v-model="author.author_name" class="form-control" type="text" required="">
                        </div>																					
        ...
        methods: {
            saveForm() {
                ...
                if(typeof app.$route.params.id !== 'undefined'){
                    axios.put("/api/v1/authors/"+app.$route.params.id,author)
                    .then(function (resp) {
                        console.log(resp);
                ...
                axios.post("/api/v1/authors",author)
                    .then(function (resp) {
                        console.log(resp);
                        app.$router.push({path: '/author'});
                    })

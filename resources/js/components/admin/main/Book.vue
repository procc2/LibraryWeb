          ...
          >
            ...
            <template v-slot:cell(has_ebook)="row">
              <b-badge
                ...
                :variant=" row.item.ebooks.length ? 'outline-success' : 'outline-secondary'"
              >
            ...
            <template v-slot:cell(delete)="row">
              <a
                ...
                @click="deleteEntry(row.item.book_id)"
              >
                <span>
                  <svg
...
export default {
    ...
    computed: {
        isSelectedAll() {
            return this.selectedItems.length >= this.books.length;
        },
        isAnyItemSelected() {
            return (
